...
//	            studentDao.write(listSinhVien);
	        ...
	        public void displayAllSV(SinhVien sinhvien) {
	    		...
	    		for(int i=0; i<size;i++) {
	    			System.out.printf(" %-3s %-20s %-6s %-20s %-6s \n",listSinhVien.get(i).getId(),listSinhVien.get(i).getName(),listSinhVien.get(i).getAge(),listSinhVien.get(i).getAddress(),listSinhVien.get(i).getDiemTb());
...
//	}
//	System.out.println("=================");
//	listSinhVien.remove(3);
//	for(SinhVien sinhvien:listSinhVien) {
//		System.out.println(sinhvien);
//	}
//	System.out.println("So phan tu con lai la: "+ listSinhVien.size());
//	listSinhVien.set(3, new SinhVien("Buon 4", 0, null, 0));
//	for(SinhVien sinhvien:listSinhVien) {
//		System.out.println(sinhvien);
//	}
//	}

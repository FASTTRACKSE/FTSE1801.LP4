...
public class xeploaiSV {
	public static void main(String[] args) {
		...
		double[] diemlp1= {8,8,8};
		double[] diemlp2= {9,9,8};
		double[] diemlp3= {10,5,8};
		...
		for (int i = 0; i <=diemTB.length- 1; i++) {
			System.out.println("STT   Họ và tên  \t Lp1 \tLp2 \t Lp3   \t ĐiemTB \t Xeploai");
			System.out.println((i+1)+".   " + hotenHS[vitri[i]]+ "\t "  + diemlp1[vitri[i]] +"\t"+ 

...
public class puzzle extends JFrame implements ActionListener {
	JButton b1, b2, b3, b4, b5, b6, b7, b8, b9, choiLai;

	puzzle() {
		super("Puzzle Game");
		JPanel jpn1 = new JPanel();
		jpn1.setLayout(new GridLayout(3, 3));
		b1 = new JButton("1"); jpn1.add(b1);
		b2 = new JButton(" "); jpn1.add(b2);
		b3 = new JButton("3"); jpn1.add(b3);
		b4 = new JButton("4"); jpn1.add(b4);
		b5 = new JButton("5"); jpn1.add(b5);
		b6 = new JButton("6"); jpn1.add(b6);
		b7 = new JButton("7"); jpn1.add(b7);
		b8 = new JButton("8"); jpn1.add(b8);
		b9 = new JButton("2"); jpn1.add(b9);
		
//		JPanel jpn2 = new JPanel(); 
//		choiLai = new JButton("Chơi lại"); jpn2.add(choiLai);
...
//		choiLai.addActionListener(this);
	}

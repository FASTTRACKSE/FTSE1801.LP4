...
public class Bai4_Menu {
	public static void main(String[] args) {
		...
		do {
			...
			switch (n) {
			case 1:
				System.out.println(PT_bac1(input));
				break;

			case 2:
				System.out.println(PT_bac2(input));
				break;

			case 3:
				System.out.println(tien_dien(input));
				break;
	...
	// Hàm giải Pt bậc 1
	public static String PT_bac1(Scanner input) {
		double a, b;
	...
	// Hàm giải PT bậc 2
	public static String PT_bac2(Scanner input) {
	...
	// Hàm tính tiền điện
	public static String tien_dien(Scanner input) {

...
public class QuanLyTienDien extends JFrame implements ActionListener {
	...
	JTextField txtMaKhachHang, txtNameKhachHang, txtDiachi, txtDienthoai, txtEmail, txtChuKyNhap, txtChiSoCongTo,
			...
			txtTimKiem1, txtMaCongToDien, txtTimKiem5, txtLoaiCongTo, txtNhaSanXuat, txtNamSanXuat;
	...
	public QuanLyTienDien() {
		...
		jScrollPane4.setPreferredSize(new Dimension(1000, 350));
		...
		txtLoaiCongTo = new JTextField(15);
		txtNhaSanXuat = new JTextField(15);
		txtNamSanXuat = new JTextField(15);
		...
		addItem(Panectdien, new JLabel("Loại công tơ (*):"), 0, 1, 1, 1, GridBagConstraints.EAST);
		addItem(Panectdien, new JLabel("Nhà sản xuất (*):"), 0, 2, 1, 1, GridBagConstraints.EAST);
		addItem(Panectdien, new JLabel("Năm sản xuất (*):"), 0, 3, 1, 1, GridBagConstraints.EAST);

		addItem(Panectdien, txtMaCongToDien, 1, 0, 2, 1, GridBagConstraints.WEST);
		addItem(Panectdien, txtLoaiCongTo, 1, 1, 2, 1, GridBagConstraints.WEST);
		addItem(Panectdien, txtNhaSanXuat, 1, 2, 2, 1, GridBagConstraints.WEST);
		addItem(Panectdien, txtNamSanXuat, 1, 3, 2, 1, GridBagConstraints.WEST);
		...
		dtm5.addColumn("Loại Công tơ");
		dtm5.addColumn("Nhà sản xuất");
		dtm5.addColumn("Năm sản xuất");
		...
		jScrollPane5.setPreferredSize(new Dimension(1000, 350));
		...
		jTable5.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String s1 = (String) jTable5.getValueAt(row, 1);
				txtLoaiCongTo.setText(s1);
				String s2 = (String) jTable5.getValueAt(row, 2);
				txtNhaSanXuat.setText(s2);
				String s3 = (String) jTable5.getValueAt(row, 3);
				txtNamSanXuat.setText(s3);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btAdd) {
			...
			if (txtMaKhachHang.getText().equals("") || txtNameKhachHang.getText().equals("")
					|| cbPhuong.getSelectedItem().toString().equals("Chọn Phường")
					|| cbQuan.getSelectedItem().toString().equals("Chọn Quận") || txtDienthoai.getText().equals("")
					|| cbCongToDien.getSelectedItem().toString().equals("Chọn mã công tơ")) {
				JOptionPane.showMessageDialog(null, "Bạn cần phải nhập vào trường còn trống");
			} else if (khachHangDAO.addKhachHang(khachHang)) {
		...
		if (e.getSource() == btAdd1) {
			...
			if (cbCongToDien1.getSelectedItem().equals("Chọn mã công tơ") || txtChuKyNhap.getText().equals("")
		...
		if (e.getSource() == btAdd5) {
			...
			congToDien.setLoaiCongTo(txtLoaiCongTo.getText());
			congToDien.setNhaSanXuat(txtNhaSanXuat.getText());
			congToDien.setNamSanXuat(txtNamSanXuat.getText());
			if (txtMaCongToDien.getText().equals("") || txtLoaiCongTo.getText().equals("")
					|| txtNhaSanXuat.getText().equals("") || txtNamSanXuat.getText().equals("")) {
				JOptionPane.showMessageDialog(null, "Bạn cần phải nhập vào trường còn trống");
			} else {
